...
export const TestimonialItem = ({ name, content }) => {
  return (
    <div>
      <div className="block rounded-lg shadow-lg bg-white">
        <div className="overflow-hidden rounded-t-lg h-28 bg-[#DB5752]"></div>
        ...
        <div className="p-6">
          ...
          <div>
            ...
            <p className="mt-4" dangerouslySetInnerHTML={{__html: content}}></p>
          </div>
        </div>
      </div>
    </div>
